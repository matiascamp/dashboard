                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <fieldset disabled={isSubmitting} className="space-y-6 min-w-0 border-0 p-0 m-0">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-[var(--foreground)]" htmlFor="invoice-option">
                                    Factura
                                </label>
                                <div className="relative">
                                    <select
                                        ...
                                        onChange={e => setFormData(prev => ({ ...prev, invoice: e.target.value as "a facturar" | "no factura" }))}
                                        className="
                                    ...
                                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
                                        <svg className="w-5 h-5 text-[var(--foreground-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/></svg>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-2">
...
onChange={e => setFormData(prev => ({
    ...
    dollarRate: e.target.value === "USD" ? (prev.dollarRate || 1) : 0
}))}
                                        className="
                                            w-full pl-4 pr-10 py-3 
                                            bg-[var(--input-bg)] 
